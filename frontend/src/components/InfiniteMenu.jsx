      ...
      this.items.map(
        item =>
          new Promise(resolve => {
            ...
            img.onerror = () => {
              console.warn("Failed to load image, using fallback:", item.image);
              ...
              fallbackImg.onerror = () => {
                ...
                finalImg.src = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=";
              };
              fallbackImg.src = "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=400&h=400&fit=crop";
            };
            img.src = item.image || "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?q=80&w=400&h=400&fit=crop";
          })
      )
    ).then(images => {
      if (!this.active) return;
...
export default function InfiniteMenu({ items = [], scale = 1.0, onItemClick = null, buttonIcon = "↗" }) {
      ...
      {activeItem && (
        <>
          ...
          <div onClick={handleButtonClick} className={`action-button ${isMoving ? 'inactive' : 'active'}`}>
            <p className="action-button-icon">{buttonIcon}</p>
          </div>
        </>
      )}
    </div>
